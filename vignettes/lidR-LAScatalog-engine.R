...
#las = clip_disc(ctg, 273500, 5274500, 40)
...
# The trees are immediately usable in subsequent analysis
trees
...
# The output has been modified by this options and it now gives
...
# Many raster have been written on disk
